...
<div id="OVERVIEW" class="container">
  <div class="row">
    <div class="col-xs-12 col-md-9 go-right">
        ...
        <div style="margin-top:10px">
          ...
          <div style="width:100%" class="fotorama bg-dark" data-allowfullscreen="true" data-nav="thumbs">
              ...
              <?php foreach($module as $item){
                  $url_imgg=$module->thumbnail;
                  $url_img_string = str_replace('http://localhost/phptravels/uploads/images/hotels/slider/thumbs/', '', $url_imgg);
                  ?><img style="width:100%" src="<?php echo $url_img_string; ?>" /><?php
      ...
      <br>
      <div class="panel panel-default">
        <div class="panel-heading go-text-right panel-purple"><?php echo trans('046');?></div>
        <div class="panel-body">
      ...
      <?php if($appModule != "offers"){ ?>
      <div class="panel panel-default">
        <div class="panel-heading go-text-right panel-green"><?php echo trans('0148');?></div>
        <div class="panel-body">
          <span class="RTL">
    ...
    <div class="col-md-3 go-left searchbox-padding">
      ...
      <div class="panel-body panel panel-default">
        <center>
          ...
          <hr>
          <div class="rounded-circle c100 p<?php echo $avgReviews->overall * 10;?>">
    ...
    <div class="clearfix"></div>
      ...
      <button  data-toggle="collapse" data-parent="#accordion" class="writeReview btn btn-success btn-lg btn-block" href="#ADDREVIEW"><i class="icon_set_1_icon-68"></i> <?php echo trans('083');?></button>
       <?php if(!empty($reviews) > 0){ ?>
      <a href="#REVIEWS" class="tabsBtn btn btn-primary btn-lg btn-block"><i class="icon_set_1_icon-93"></i> <?php echo trans('0394');?></a>
       <?php }  ?>
      <?php } ?>
