      ...
      <div class="wow fadeIn col-lg-4 col-md-4 col-sm-4 offset-0 go-right rtl_pic">
        ...
        <div class="img_list">
          <a href="<?php echo $item->slug;?>">
              <?php $url_img = $item->thumbnail;
              $url_img_string = str_replace('http://localhost/phptravels/uploads/images/hotels/slider/thumbs/', '', $url_img);
              ?>
            <img src="<?php echo $url_img_string; ?> " class="" data-lazy="<?php echo $url_img_string; ?>" alt="<?php echo character_limiter($item->title,20);?>">
