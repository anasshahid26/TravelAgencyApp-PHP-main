    ...
    <form action="//whitelabel.dohop.com/w/<?php echo $themeData->dohopusername; ?>/" method="GET" target="_blank">
        ...
        <div class="col-md-2 col-xs-12">
            <div class="row">
                <label>&nbsp;</label>
                <div class="clearfix"></div>
                <button type="submit" value="<?php echo trans('012'); ?>"  class="btn-primary btn btn-lg btn-block"><?php echo trans('012'); ?></button>
            </div>
        </div>
    </form>
          ...
          if ($(window).scrollTop() > foot) {
            ...
            <div class="<?php echo $col4; ?>">
                <div class="row">
                    ...
                    <div class="clearfix"></div>
                    <i class="iconspane-lg icon_set_1_icon-41"></i>
                    <input type="text" name="txtSearch" ng-model="selected" placeholder="<?php if ($module == 'hotels') { echo trans('026'); } elseif ($module == 'tours') { echo trans('0526'); } ?>" uib-typeahead="result as result.name for result in getResults($viewValue,'<?php echo base_url(); ?>home/suggestions/<?php echo $module; ?>')" typeahead-loading="loadingLocations" typeahead-no-results="noResults" typeahead-popup-template-url="customTemplateResults.html" typeahead-on-select="onSelect($item, $model, $label)" typeahead-min-length='1' class="form input-lg">
     ...
     <?php if ($module == "hotels" || $module == "ean") { ?>
        ...
        <div class="<?php echo $button; ?>">
            <div class="row">
                ...
                <div class="clearfix"></div>
                <button type="submit"  class="btn-primary btn btn-lg btn-block"><?php echo trans('012'); ?></button>
            </div>
        </div>
    </form>
    <?php } } ?>
